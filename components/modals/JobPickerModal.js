...
export default class JobPickerModal extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const dropdown_6_icon = this.state.dropdown_6_icon_heart ? require('../../assets/images/gawahelp.png') : require('../../assets/images/gawahelp.png');
    return (
  ...
  _dropdown_2_renderRow(rowData, rowID, highlighted) {
    let icon = highlighted ? require('../../assets/images/gawahelp.png') : require('../../assets/images/gawahelp.png');
    let evenRow = rowID % 2;
    return (
...
//AppRegistry.registerComponent('JobPickerModal', () => JobPickerModal);